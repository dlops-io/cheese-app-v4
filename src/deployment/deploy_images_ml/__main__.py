...
image_config = {
    "image_name": "cheese-app-data-collector",
    "context_path": "../../data-collector",
    "dockerfile": "Dockerfile"
}
data_collector_image = docker_build.Image(
...
pulumi.export("cheese-app-data-collector-ref", data_collector_image.ref)
pulumi.export("cheese-app-data-collector-tags", data_collector_image.tags)

# Docker Build + Push -> Frontend
image_config = {
    "image_name": "cheese-app-data-processor",
    "context_path": "../../data-processor",
    "dockerfile": "Dockerfile"
}
data_processor = docker_build.Image(
    f"build-{image_config["image_name"]}",
    tags=[pulumi.Output.concat(registry_url, "/", image_config["image_name"], ":", timestamp_tag)],
    context=docker_build.BuildContextArgs(location=image_config["context_path"]),
    dockerfile={"location": f"{image_config["context_path"]}/{image_config["dockerfile"]}"},
...
pulumi.export("cheese-app-data-processor-ref", data_processor.ref)
pulumi.export("cheese-app-data-processor-tags", data_processor.tags)